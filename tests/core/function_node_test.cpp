...
TEST_F(FunctionNodeTest, Parameters_AddOne_IncreasesInputPinCount) {
    ...
    graph_.AddParameter(node, "x", core::NodeBase::PinDataType::kInt);
...
TEST_F(FunctionNodeTest, Parameters_AddMultiple_CorrectPinCountAndTypes) {
    ...
    graph_.AddParameter(node, "a", core::NodeBase::PinDataType::kInt);
    graph_.AddParameter(node, "b", core::NodeBase::PinDataType::kFloat);
    graph_.AddParameter(node, "c", core::NodeBase::PinDataType::kBool);
...
TEST_F(FunctionNodeTest, Parameters_InputPinNames_MatchParameterNames) {
    ...
    graph_.AddParameter(node, "alpha", core::NodeBase::PinDataType::kInt);
    graph_.AddParameter(node, "beta", core::NodeBase::PinDataType::kFloat);
...
TEST_F(FunctionNodeTest, Parameters_RemoveOne_DecreasesPinCount) {
    ...
    graph_.RemoveParameter(node, static_cast<uint8_t>(0));
    EXPECT_EQ(node->GetInputPinCount(), 1);
...
TEST_F(FunctionNodeTest, Parameters_RemoveOutOfRange_DoesNotCrash) {
    ...
    EXPECT_NO_THROW(graph_.RemoveParameter(node, static_cast<uint8_t>(0)));
    EXPECT_NO_THROW(graph_.RemoveParameter(node, static_cast<uint8_t>(255)));
}
...
TEST_F(FunctionNodeTest, Link_LiteralToFunctionInput_Succeeds) {
    ...
    auto *func = graph_.AddNode<core::FunctionNode>(
        core::NodeBase::NodeKind::kFunction);
    graph_.AddParameter(func, "x", core::NodeBase::PinDataType::kInt);
...
TEST_F(FunctionNodeTest, Link_MultipleInputs_AllConnected) {
    ...
    auto *func = graph_.AddNode<core::FunctionNode>(
        core::NodeBase::NodeKind::kFunction);
    graph_.AddParameter(func, "a", core::NodeBase::PinDataType::kInt);
    graph_.AddParameter(func, "b", core::NodeBase::PinDataType::kFloat);
...
TEST_F(FunctionNodeTest, Serialize_ContainsAllFields) {
    ...
    node->set_return_type(core::NodeBase::PinDataType::kInt);
    graph_.AddParameter(node, "x", core::NodeBase::PinDataType::kInt);
    graph_.AddParameter(node, "y", core::NodeBase::PinDataType::kFloat);
...
TEST_F(FunctionNodeTest, Deserialize_RoundTrip_PreservesData) {
    ...
    graph_.AddParameter(original, "a", core::NodeBase::PinDataType::kInt);
    graph_.AddParameter(original, "b", core::NodeBase::PinDataType::kString);
...
TEST_F(FunctionNodeTest, SaveAndLoad_PreservesFunctionNode) {
    ...
    func->set_name("add");
    func->set_return_type(core::NodeBase::PinDataType::kInt);
    graph_.AddParameter(func, "lhs", core::NodeBase::PinDataType::kInt);
    graph_.AddParameter(func, "rhs", core::NodeBase::PinDataType::kInt);
...
TEST_F(FunctionNodeTest, AddParameter_Multiple_CreatesOneNodePerParam) {
    ...
    graph_.AddParameter(func, "a", core::NodeBase::PinDataType::kInt);
    graph_.AddParameter(func, "b", core::NodeBase::PinDataType::kFloat);
    graph_.AddParameter(func, "c", core::NodeBase::PinDataType::kBool);
...
TEST_F(FunctionNodeTest, RemoveParameterByIndex_RemovesNodeFromBody) {
    ...
    graph_.RemoveParameter(func, static_cast<uint8_t>(0));
...
TEST_F(FunctionNodeTest, RemoveParameterByName_RemovesNodeFromBody) {
    ...
    graph_.RemoveParameter(func, std::string("b"));
...
TEST_F(FunctionNodeTest, RemoveParameterByName_NonExistent_DoesNothing) {
    ...
    graph_.RemoveParameter(func, std::string("does_not_exist"));
