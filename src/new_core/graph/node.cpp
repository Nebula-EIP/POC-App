...
const std::vector<Pin> &Node::inputPins() const noexcept
{
    return _input_pins;
}
...
size_t Node::inputPinsCount() const noexcept
{
...
void Node::RemoveProperty(PropertyId id)
{
