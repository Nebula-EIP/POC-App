...
int main(void) {
    try {
        ...
        auto lit1 = graph.AddNode<core::LiteralNode>(core::NodeBase::NodeKind::kLiteral);
        auto lit2 = graph.AddNode<core::LiteralNode>(core::NodeBase::NodeKind::kLiteral);
        auto var1 = graph.AddNode<core::VariableNode>(core::NodeBase::NodeKind::kVariable);
