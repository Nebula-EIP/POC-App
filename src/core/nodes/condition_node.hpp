...
class ConditionNode : public NodeBase {
   public:
    ...
    /**
     * @brief Sets the display name of the condition node.
     * @param name The new name to set for the condition node.
     */
    void SetName(const std::string &name);

    /**
     * @brief Gets the display name of the condition node.
     * @return The current name of the condition node.
     */
    ...
    /**
     * @brief Serializes this node's data into JSON format.
     * @return A JSON object representing this node's data.
     */
    nlohmann::json Serialize() const override;

    /**
     * @brief Deserializes this node's data from a JSON object.
   ...
   private:
    ...
    /**
     * @brief Private constructor for ConditionNode, called by the Graph when creating a new node.
     * @param id The unique identifier for this node.
     * @param kind The kind of the node, should be NodeKind::kCondition.
    ...
    /**
     * @brief Initializes the input and output pins for this node.
     */
