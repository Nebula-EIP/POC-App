...
class LoopNode : public NodeBase {
   public:
    ...
    /**
     * @brief Sets the display name of the loop node.
     * @param name The new name to set for the loop node.
     */
    void SetName(const std::string &name);
    /**
     * @brief Gets the display name of the loop node.
     * @return The current name of the loop node.
     */
