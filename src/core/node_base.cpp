...
utils::WrappedVector2 core::NodeBase::GetPosition() const { return position_; }
...
core::NodeBase::DeserializeFactory(const nlohmann::json &json,
    ...
    utils::WrappedVector2 position = {0.0f, 0.0f};
...
void core::NodeBase::DrawBody() {
    ...
    // Draw Node body
    utils::DrawRectangleWrapped(position_.x, position_.y, 100, 50, color);
    if (selected_) {
