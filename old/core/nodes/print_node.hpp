...
class PrintNode : public NodeBase {
   public:
    ...
    /**
     * @brief Sets the display name of the print node.
     * @param name The new name to set for the print node.
     */
    void SetName(const std::string &name);

    /**
     * @brief Gets the display name of the print node.
     * @return The current name of the print node.
     */
     ...
     * @param json The JSON object containing the node data to deserialize.
     * @return An expected value indicating success or an error message.
     */
   ...
   private:
     ...
     */
    PrintNode(uint32_t id, NodeKind kind,
